...
if __name__ == '__main__':
    ...
    regTree2 = createTree(myMat2, ops=(0, 1))
    print("Before pruning:", regTree2)
    myDataTest2 = loadDataSet("ex2test.txt")
    myMatTest2 = np.mat(myDataTest2)
    regPrunedTree2 = prune(regTree2, myMatTest2)
    print("After pruning:", regPrunedTree2)
